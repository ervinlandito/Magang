...
function confirmPasswordValidation(confirmPassword, password) {
  if (confirmPassword.length < 8) {
    return "Confirm password tidak boleh kurang dari 8 karakter.";
  }
...
form.addEventListener("submit", async (e) => {
  ...
  const confirmPasswordValidationError = confirmPasswordValidation(
    confirmPasswordInput.value,
    passwordInput.value
  );
  if (confirmPasswordValidationError) {
    confirmPasswordError.textContent = confirmPasswordValidationError;
    isValid = false;
  }
...
module.exports = {
  validateNIP,
  validatePassword,
  confirmPasswordValidation, // Menambahkan confirmPasswordValidation di sini
};
